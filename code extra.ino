...
void ajouterData(int code_1 , int code_2 , int code_3 , int code_4)
{
  int i = 0;

  if (buffer_vide == true)
  {
    Serial.print("nbr_data : ");
    Serial.println(nbr_data);

    Serial.print("stock : ");
    Serial.println(emplacement_stock);

    stock[1][emplacement_stock] = code_1;
    stock[2][emplacement_stock] = code_2;
    stock[3][emplacement_stock] = code_3;
    stock[4][emplacement_stock] = code_4;
...
ajouterData(data_1, data_2, data_3, data_4 );
}
